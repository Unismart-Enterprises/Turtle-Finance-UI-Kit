...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#22310a", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#8fd129", textDisabled: "#BDC2C4", textSubtle: "#8f80ba", borderColor: "#E9EAEB", card: "#1b2b03", gradients: {
